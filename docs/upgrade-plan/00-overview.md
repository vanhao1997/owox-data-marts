...
| Toast system         | Sonner only — DA FIX                                                   |
...
- Task 5.2: i18n namespace split
- Task 6.3-6.4: API latency + feature flags
- Task 7.1-7.3, 7.5: DX tools

## Trang thai Production Reliability

Cac tasks SAU da duoc trien khai trong code, KHONG can lam lai:

- Sonner migration — DA XONG
- TypeScript strict mode — DA XONG
- EN/VI synchronization — DA XONG
- Bundle analyzer — DA XONG
- Hide 6 unused connectors in create flow — DA XONG

Cac release blockers con lai:

- Can revoke/rotate Coolify tokens da xuat hien ngoai secret store.
- Can Admicro credential hop le do user nhap truc tiep trong UI de chay E2E that.

Da thay the Fibery bang GitHub Issues mien phi cho release tracking. Changeset
cho cac thay doi dang cho release da duoc gan GitHub Issue number.
