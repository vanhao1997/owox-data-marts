...
| Report Run           | Excel Report Run         | Represents Report Runs executed in the Cloud edition on [app.p2pdigital.vn](https://app.p2pdigital.vn). Data was pulled from a Data Mart into a Microsoft Excel workbook by the P2PDigital add-in.                                                                                                                           |
