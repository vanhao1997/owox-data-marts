...
/**
 * Full walkthrough for the Looker Studio (Data Studio) destination: creating
 * the destination, copying its JSON Config, and connecting the P2PDigital Data Marts
